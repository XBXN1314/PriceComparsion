...
public class DetailInfoBasedOnSearchServlet extends HttpServlet {
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		List<DetailInfo> detailInfoList = DetailInfoDao.getBookDetailInfoByURLBasedOnSearch(picUrl);
